/*
  ...
  - You are about to drop the column `authoId` on the `posts` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "posts" DROP CONSTRAINT "posts_authoId_fkey";
